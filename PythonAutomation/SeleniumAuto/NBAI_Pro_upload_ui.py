...
from PythonAutomation.SeleniumAuto import NBAI_Pro_base_ui


class OrionProUploadUI(unittest.TestCase):

    def setUp(self):
        # self.driver = webdriver.Chrome("FilesOfUI/chromedriver")  # Ubuntu
        self.driver = webdriver.Chrome("FilesOfUI/chromedriver.exe")  # Windows

        self.driver.implicitly_wait(30)
        self.verificationErrors = []
        self.accept_next_alert = True
        self.valid_username = 'mikesiwer10@gmail.com'
        self.valid_password = 'a123456'
        self.task_file_path = os.path.abspath(os.path.join(os.path.dirname(__file__), './FilesOfUI'))
        self.task_file_name = '/Test001.zip'
        self.task_name = "NBAI-" + str(datetime.date.today()) + str("-UI-test3")
        self.message = "4"
    ...
    def test_upload_ui(self):
        ...
        login_page = NBAI_Pro_base_ui.LoginBase(self.driver)
        ...
        time.sleep(1)
        driver.find_element_by_id("deposit").send_keys("1375")
        # # driver.find_element_by_xpath(
        ...
        # driver.find_element_by_name("taskname").send_keys(self.task_name)
        # time.sleep(3)
        #
        ...
        # # Upload files need 1375 Coin Money
